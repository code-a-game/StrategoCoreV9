function drawRulesSection() {
 ...
 const rules = 
        "This game is perfect for a Friday Fun or team-building \n" +
        "activity. Two teams compete head-to-head to determine  \n" +
        "who comes out on top. Each team is encouraged to have  \n" +
        "a group call to share knowledge and coordinate strategy.  \n\n" +
        ...
        "with the mouse to shoot (10 shots and the oppenent is eliminated). Use \n" + 
        "Warp Gates to warp to other planets and avoid canons on planet Ice Cube. \n\n" +

        "The spacecrafts for GREEN/PURPLE team have green/purple exhaust. \n" +
        "Touch an opponent to battle and eliminate their Core Command to win. \n" +
        "Agree how long to play for. May the best team win! Game by Jens Valdez \n" +
...
class BackgroundManager {
    ...
    initialize() {
        ...
        this.targetStar = new DecorativeYellowStar(1300, 300);
